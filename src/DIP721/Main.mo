...
import Types "./types";
//dfx deploy NFTSale --argument="(\"Connect\", \"connect\", \"connect\", \"connectNFT\", principal \"zr7fa-gnm7z-wcno5-cl2jv-y3xs4-ehyen-4t5sz-xcdvc-zo4gb-6vu5b-4qe\")"
shared(msg) actor class NFToken(
    ...
    // List of Token Entries Data
    private stable var tokensEntries : [(Nat, TokenInfo)] = [];
    // List of User Entries Data
